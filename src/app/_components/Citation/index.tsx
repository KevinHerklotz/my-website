...
export default function Citation({ quote, who }: CitationProps) {
  return (
    <>
      <blockquote className="relative inline-block max-w-3xl overflow-hidden rounded-md border-2 border-solid border-neutral-100 border-opacity-50 bg-white bg-opacity-10 p-3 font-extralight italic">
        <motion.div
